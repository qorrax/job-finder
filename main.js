...
//     const applyButton = document.createElement("p")
// }


// titleElement.textContent = job.company;
// companyElement.textContent = job.company;
// locationElement.textContent = job.location;
// descriptonElement.textContent = job.description;
// applyButton.textContent = "apply Now";
// applyButton.href = job.apply_url;


// //  connect element to the Job Element 

// jobElement.appenchild(titleElement);
// JobElement.appenchild(companyElement);
// jobElement.appenchild(locationElement);
// jobElement.appenchild(description);
// jobElement.appenchild(applyButton);


// //   append the job element to the featured jobs container

//   featured-jobs.appenchild(jobElement)
